...
```{r Example 1 - Create nomogram with shap}
nomogram_with_shap <-
  create_nomogram(nomogram_features, nomogram_outputs, nomogram_shaps)
```

```{r figure-2, echo=FALSE, fig.height=3, fig.width=12}
nomogram_with_shap
```
...
```{r figure-3, echo=FALSE, fig.height=4.5, fig.width=10}
nomogram2
```
...
```{r figure-4, echo=FALSE, fig.height=6, fig.width=12}
nomogram2_with_shap
```
...
```{r figure-6, echo=FALSE, fig.height=7.5, fig.width=12}
nomogram3_with_shap
```
...
```{r figure-7, echo=FALSE, fig.height=4.5, fig.width=10}
nomogram4
```
...
```{r figure-10, echo=FALSE, fig.height=7.5, fig.width=12}
nomogram4_with_shap
```
